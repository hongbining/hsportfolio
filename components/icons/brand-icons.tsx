...
/**
 * Brand marks are not part of lucide-react, so they are provided here as
 * lightweight, currentColor-driven SVGs. Decorative by default — pass an
 * accessible name via the wrapping element.
 */
